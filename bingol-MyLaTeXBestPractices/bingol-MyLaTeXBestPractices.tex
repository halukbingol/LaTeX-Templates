...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ V define file: code-sample-B.bib
\begin{filecontents*}{code-sample.bib}
@misc{enwiki:matrix,
    author = "{Wikipedia contributors}",
    title = "Matrix (mathematics) --- {Wikipedia}{,} The Free Encyclopedia",
    year = "2021",
    url = "https://en.wikipedia.org/w/index.php?title=Matrix_(mathematics)&oldid=1021630293",
    note = "[Online; accessed 10-May-2021]"
}
\end{filecontents*}
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ A
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ V define file: code-sample.java
\begin{filecontents*}{code-sample.java}
public class Node {
	String name;
	String lastName;
	Node link;
...
Use \hCode{misc} bib-type for citing a web page~\cite{%
	se:HowToCiteWebPage}.
This is an example of a citation to matrix article of wikipedia~\cite{%
	enwiki:matrix}.
...
% +++++++++++++++++++++++++++++++++++++++ V
%: -List.
\lstinputlisting[language=BibTeX,label=lst:QuickStart,caption=misc bib-type]
	{code-sample.bib}
% +++++++++++++++++++++++++++++++++++++++ A
